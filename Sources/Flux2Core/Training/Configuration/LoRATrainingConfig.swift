...
public struct LoRATrainingConfig: Codable, Sendable {
    ...
    public struct ValidationPromptConfig: Sendable, Codable {
        ...
        public var isVLMGenerated: Bool  // Whether this prompt was auto-generated by VLM
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case isVLMGenerated = "is_vlm_generated"
        }

        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            prompt = try container.decode(String.self, forKey: .prompt)
            is512 = try container.decodeIfPresent(Bool.self, forKey: .is512) ?? true
            is1024 = try container.decodeIfPresent(Bool.self, forKey: .is1024) ?? false
            applyTrigger = try container.decodeIfPresent(Bool.self, forKey: .applyTrigger) ?? true
            seed = try container.decodeIfPresent(UInt64.self, forKey: .seed)
            referenceImage = try container.decodeIfPresent(URL.self, forKey: .referenceImage)
            isVLMGenerated = try container.decodeIfPresent(Bool.self, forKey: .isVLMGenerated) ?? false
        }
    }
